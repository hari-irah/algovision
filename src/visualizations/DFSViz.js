// src/visualizations/DFSViz.js
import React from 'react';
import '../styles/BFSViz.css'; // We can reuse the same CSS!
...
const DFSViz = ({ graph, visualState }) => {
  if (!visualState || !visualState.nodeStates) return null;
  
  const { nodeStates, stack, highlightedEdge } = visualState;
  ...
  return (
    <div className="bfs-viz-container">
      ...
      <div className="queue-display"> {/* Reusing CSS class name */}
